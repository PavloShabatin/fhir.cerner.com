  ...
  module Resources
    ...
    R4_ORGANIZATION_CAREGIVER_SEARCH_BUNDLE ||= {
      ...
      'link': [
        {
          'relation': 'self',
          'url': 'https://fhir-open.sandboxcerner.com/r4/dacc6494-e336-45ad-8729-b789ff8663c6/Organization/$get-cg-for-mrcu?_id=3304067'
        }
      ],
      'entry': [
        {
          'fullUrl': 'https://fhir-open.sandboxcerner.com/r4/dacc6494-e336-45ad-8729-b789ff8663c6/Organization/3304066',
          'resource': {
            'resourceType': 'Organization',
            'id': '3304066',
            'meta': {
            ...
            'identifier': [
              ...
              },
              {
                ...
                'type': {
                  'coding': [
                    {
                      'system': 'https://fhir.cerner.com/dacc6494-e336-45ad-8729-b789ff8663c6/codeSet/334',
                      'code': 'OID',
                      'display': 'OID',
                      'userSelected': true
                    },
            ...
            'type': [
              {
                'coding': [
                  {
                    'system': 'https://fhir.cerner.com/dacc6494-e336-45ad-8729-b789ff8663c6/codeSet/278',
                    'code': 'HOSPITAL',
                    'display': 'Hospital',
                    'userSelected': true
                  },
